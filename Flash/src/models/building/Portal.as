package models.building
{
	...
	import models.away3D.buildings.Portal3D;
	...
	public class Portal  extends BaseBuilding
	{
		// Information
		...
		override public function isObject(s:BuildingObject):Boolean{
			return s is Portal;
		}
		...
		override public function isEqual(s:BuildingObject) : Boolean {
			if(s is Portal){
